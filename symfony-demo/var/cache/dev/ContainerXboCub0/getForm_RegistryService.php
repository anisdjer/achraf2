...
require_once $this->targetDirs[3].'/vendor/symfony/form/FormExtensionInterface.php';
require_once $this->targetDirs[3].'/vendor/symfony/form/Extension/DependencyInjection/DependencyInjectionExtension.php';
require_once $this->targetDirs[3].'/vendor/symfony/form/FormRegistryInterface.php';
require_once $this->targetDirs[3].'/vendor/symfony/form/FormRegistry.php';
...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CommentType' => function () {
    ...
    return ($this->privates['App\Form\Type\DateTimePickerType'] ?? $this->load(__DIR__.'/getDateTimePickerTypeService.php'));
}, 'App\\Form\\Type\\TagsInputType' => function () {
    return ($this->privates['App\Form\Type\TagsInputType'] ?? $this->load(__DIR__.'/getTagsInputTypeService.php'));
